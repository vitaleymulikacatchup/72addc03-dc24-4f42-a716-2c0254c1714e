...
export const metadata: Metadata = {
  title: "FlexFit Studio - Women's Pilates Classes",
  description: "Transform your body and mind at FlexFit Studio. Join our welcoming women-only pilates classes with expert instructors. Mat, Reformer & Prenatal options available.",
  keywords: "pilates, women's fitness, mat pilates, reformer pilates, prenatal pilates, wellness, strength training, flexibility",
  openGraph: {
    title: "FlexFit Studio - Women's Pilates Classes",
    description: "Transform your body and mind at FlexFit Studio. Join our welcoming women-only pilates classes with expert instructors.",
    siteName: "FlexFit Studio",
    images: [
      {
        url: "https://images.pexels.com/photos/901439/pexels-photo-901439.jpeg?auto=compress&cs=tinysrgb&h=650&w=940",
        alt: "Women practicing pilates in a peaceful studio environment"
      }
    ],
    type: "website"
  },
  twitter: {
    ...
    title: "FlexFit Studio - Women's Pilates Classes",
    description: "Transform your body and mind at FlexFit Studio. Join our welcoming women-only pilates classes with expert instructors.",
    images: ["https://images.pexels.com/photos/901439/pexels-photo-901439.jpeg?auto=compress&cs=tinysrgb&h=650&w=940"]
  },
  robots: {
    index: true,
    follow: true
